...
* WN-check_CVE-2024-1086
- Check if mitigation for CVE-2024-1086 has been applied
* WN-check_CVE-2025-21756
- Check if mitigation for CVE-2025-21756 has been applied
* WN-check_CVE-2025-38352
- Check if mitigation for CVE-2025-38352 has been applied
* WN-check_CVE-2026-31431
- Check if mitigation for CVE-2026-31431 has been applied
* WN-check_CVE-2026-43284
- Check if mitigation for CVE-2026-43284 has been applied
* WN-check_CVE-2026-46300
- Check if mitigation for CVE-2026-46300 has been applied
%prep
%setup -q
...
* Wed May 06 2026 Jakub Havrila <havrila@cesnet.cz> - 2.1.28-0
- Added mitigation check for CVE-2026-31431.

* Wed Sep 24 2025 Jakub Havrila <havrila@cesnet.cz> - 2.1.27-0
- Added mitigation check for CVE-2025-38352.

* Tue Sep 09 2025 Jakub Havrila <havrila@cesnet.cz> - 2.1.26-0
- Added lsmod check to CVE-2024-1086.

* Wed Jul 02 2025 Jakub Havrila <havrila@cesnet.cz> - 2.1.25-0
- Updated CVE-2025-21756 mitigation probe.

* Wed Jun 04 2025 Jakub Havrila <havrila@cesnet.cz> - 2.1.24-0
- Added mitigation check for CVE-2025-21756.

* Tue Nov 12 2024 Jakub Havrila <havrila@cesnet.cz> - 2.1.23-0
- Added mitigation check for CVE-2024-1086.
...
* Wed Dec 21 2022 Kyriakos Gkinis <kyrginis@admin.grnet.gr> - 2.1.17-0
- Added node architecture and OS to the output of check_pakiti_vuln probe.

* Thu Dec 01 2022 Jakub Havrila <havrila@cesnet.cz> - 2.1.16-0
